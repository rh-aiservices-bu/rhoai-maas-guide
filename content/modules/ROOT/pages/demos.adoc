...
| Fed Aura Capital Scenario
| Bank-level model governance: seven Fed Aura Capital divisions (Sales, Branch, Credit, Developers, IT, Risk, Marketing), six on-prem + cloud models, differentiated access and per-model hourly caps. Production guide for the 3.6 product video: video structure, talk track, artwork, demo environment, and workshop extensions. *Recommended starting point for enterprise demos.*
