...
The default instance type is `g6.2xlarge` (1x L4, 24 GB VRAM) - enough for Gemma 2 9B FP8, Granite tiny, and gpt-oss-20b (quantized). Edit the template to use `g6e.2xlarge` (1x L40S, 48 GB VRAM) for more VRAM headroom (longer context, larger models).
